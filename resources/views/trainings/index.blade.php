...
@section('konten')
    ...
    <div class="col-md-4">
        ...
        <div class="card-body">
            ...
            <div class="h3 m-0">{{ Auth::user()->trainings->count() }}</div>
        </div>
        </div>
    </div>
    <div class="col-md-4">
        ...
        <div class="card-body">
            ...
            <div class="h3 m-0">{{ Auth::user()->trainings->sum('duration') }}</div>
        </div>
        </div>
    </div>
    <div class="col-md-4">
        ...
        <div class="card-body">
            ...
            <div class="h3 m-0">{{ round((Auth::user()->trainings->sum('duration') / 20) * 100, 2) }}%</div>
        </div>
        </div>
    </div>
    <div class="col-md-12">
